package com.taller_springflux.spring_reactor.exception;
...
public class WebExceptionHandler extends AbstractErrorWebExceptionHandler {
    ...
    public WebExceptionHandler(ErrorAttributes errorAttributes,
                               ...
                               ServerCodecConfigurer configures) {
        super(errorAttributes, resources, applicationContext);
        setMessageWriters(configures.getWriters());
    }
    ...
    private Mono<ServerResponse> renderErrorResponse(ServerRequest request) {
        ...
        // Obtaining exception error message
